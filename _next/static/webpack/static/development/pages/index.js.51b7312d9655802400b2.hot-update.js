...
function PublicationSimple(props) {
  var publication = props.publication,
      ...
      style = props.style;
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "pub mt-3 mb-1 ".concat(className),
    style: style
  }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "pub-info"
    ...
    className: "pub-venue"
  }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", null, "In ", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("i", null, publication.venue.title), ", ", publication.date, publication.note && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", {
    dangerouslySetInnerHTML: {
      __html: Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_2__["markedInline"])(publication.note)
    }
  }), "."))));
...
//# sourceMappingURL=index.js.51b7312d9655802400b2.hot-update.js.map