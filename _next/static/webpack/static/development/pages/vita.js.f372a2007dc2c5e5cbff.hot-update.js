...
/* harmony import */ var _Education_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Education.scss */ "./src/pages/vita/Education.scss");
/* harmony import */ var _Education_scss__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_Education_scss__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _components_CVTable__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../components/CVTable */ "./src/components/CVTable.jsx");
...
//     <tr>
//       <td className="date">
//         <span className="date-from">{formatDate(education.from, education.from)}</span>
//         <span className="date-to">{formatDate(education.to, education.to)}</span>
//       </td>
//       <td className="content">
//         <span className="degree" dangerouslySetInnerHTML={{ __html: markedInline(education.degree) }}></span>
//         <br />
//         <span className="institute" dangerouslySetInnerHTML={{ __html: markedInline(education.university) }} />
//         {education.location}
//         <br />
//         {/* {marked(education.content)} */}
//         <div dangerouslySetInnerHTML={{ __html: marked(education.content) }}/>
//       </td>
//     </tr>
//   );
// }
...
function Educations(props) {
  ...
  }), educations && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_CVTable__WEBPACK_IMPORTED_MODULE_8__["default"], {
    items: items,
...
//# sourceMappingURL=vita.js.f372a2007dc2c5e5cbff.hot-update.js.map